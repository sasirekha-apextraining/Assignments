...
//Getting Connection using MS Access
	...
	public static Connection getConnection() throws Exception {
		...
		try {
			...
			dbConn = DriverManager.getConnection(url, "root", "root1234");
...
// EMailAddress Queries
	...
	public static void updateEMailAddress(EMailAddressVOO inEMailAddress) throws Exception {
		...
		try {
			...
			/*
			 * pStmt = dbConn.
			 * prepareStatement("UPDATE emailaddress SET emailadress = ?, firstname = ? middlename = ? lastname = ?, homephone = ?, workphone = ?, mobilephone = ?, groupid = ?"
			 * ); pStmt.setString(1, inEMailAddress.geteMailID()); pStmt.setString(2,
			 * inEMailAddress.getfName()); pStmt.setString(3, inEMailAddress.getmName());
			 * pStmt.setString(4, inEMailAddress.getlName()); pStmt.setString(5,
			 * inEMailAddress.gethPhone()); pStmt.setString(6, inEMailAddress.getwPhone());
			 * pStmt.setString(7, inEMailAddress.getmPhone()); pStmt.setString(8,
			 * inEMailAddress.getgroupID());
			 * 
			 */
			pStmt = dbConn
