...
<body bgcolor="#ffffee">
	<center>
		...
		%>
		<h3>
			<font color="red" face="Arial, Helvetica, sans-serif" size="2">Please
				correct the following errors and try again:</font>
		</h3>
		<ul>
			<font size="2" color="black" face="Arial, Helvetica, sans-serif"><%=request.getSession().getAttribute("Errors")%></font>
		</ul>
		<%
		}
		%>
		...
		<form action="http://localhost:8080/mysite/servlet/emailaddressdtls">
			Email ID: <input type=text name="emailid" value="" size=20 class="tf" />&nbsp;&nbsp;<br>
